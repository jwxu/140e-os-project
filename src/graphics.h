...
static color_t SILVER = {0xC0, 0xC0, 0xC0};
static color_t GRAY = {0x80, 0x80, 0x80};
static color_t WHITE = {0xFF, 0xFF, 0xFF};
static color_t MAROON = {0x00, 0x00, 0x80};
static color_t RED = {0x00, 0x00, 0xFF};
static color_t GREEN = {0x00, 0x80, 0x00};
static color_t LIME = {0x00, 0xFF, 0x00};
static color_t OLIVE = {0x00, 0x80, 0x80};
static color_t YELLOW = {0x00, 0xFF, 0xFF};
static color_t NAVY = {0x80, 0x00, 0x00};
static color_t BLUE = {0xFF, 0x00, 0x00};
static color_t TEAL = {0x80, 0x80, 0x00};
static color_t AQUA = {0xFF, 0xFF, 0x00};
static color_t ORANGE = {0x00, 0x8C, 0xFF};

static unsigned color_to_int(color_t color) {
    unsigned val = *(unsigned *)&color;
    return val;
}

static color_t int_to_color(unsigned val) {
    color_t color = {.red = val >> 16, .green = val >> 8, .blue = val};
    return color;
}
...
static unsigned char font[FONT_NUMGLYPHS][FONT_BPG] = {
